#!/usr/bin/env bash
#
# tessera_processor.sh — Sentinel-1, Sentinel-2 & Landsat Parallel Processing Pipeline
...
BASE_DIR="/scratch/zf281/tessera2/data/borneo/output/2024"
...
: '
landsat_stack 0.1.0
Process Landsat data for a single tile

USAGE:
    landsat_stack [OPTIONS] --input-dir <input-dir> --output-dir <output-dir>
...
./landsat_stack \
  --input-dir "${BASE_DIR}/data_landsat_raw" \
  --output-dir $OUT_DIR \
  --parallel 16 \
  --rate $DOWNSAMPLE_RATE
